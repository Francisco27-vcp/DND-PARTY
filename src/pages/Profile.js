...
const s = {
  ...
  card: { background: 'var(--panel)', border: '1px solid var(--line)', borderTop: '3px solid var(--gold)', padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' },
  avatarSection: { display: 'flex', gap: '20px', alignItems: 'flex-start' },
  avatarWrap: { width: '100px', height: '100px', flexShrink: 0, border: '2px solid var(--gold-dim)', overflow: 'hidden', position: 'relative' },
  avatarImg: { width: '100%', height: '100%', objectFit: 'cover' },
  avatarPlaceholder: { width: '100%', height: '100%', background: 'rgba(201,164,73,0.08)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '4px' },
  avatarInitial: { fontFamily: 'Cinzel,serif', fontSize: '20px', fontWeight: '700', color: 'var(--gold)' },
  avatarName: { fontFamily: 'Cinzel,serif', fontSize: '20px', fontWeight: '700', color: 'var(--gold-bright)', letterSpacing: '1px' },
  avatarEmail: { fontFamily: 'Crimson Pro,serif', fontSize: '13px', color: 'var(--gold-dim)', marginTop: '3px' },
  roleBadge: { display: 'inline-block', fontFamily: 'Cinzel,serif', fontSize: '9px', letterSpacing: '2px', color: 'var(--gold)', border: '1px solid var(--gold-dim)', padding: '3px 10px', textTransform: 'uppercase' },
  fileLabel: { fontFamily: 'Cinzel,serif', fontSize: '9px', letterSpacing: '1.5px', color: 'var(--gold-dim)', textTransform: 'uppercase', cursor: 'pointer', border: '1px solid var(--line)', padding: '5px 10px', display: 'inline-block', transition: 'all 0.2s' },
  divider: { height: '1px', background: 'linear-gradient(to right, var(--line), transparent)' },
  ...
  roleBtn: { background: 'transparent', border: '1px solid var(--line)', color: 'var(--gold-dim)', fontFamily: 'Cinzel,serif', fontSize: '10px', letterSpacing: '1px', padding: '8px 14px', cursor: 'pointer', textTransform: 'uppercase', transition: 'all 0.2s' },
  roleBtnActive: { background: 'rgba(201,164,73,0.12)', borderColor: 'var(--gold-dim)', color: 'var(--gold-bright)' },
  textarea: { background: 'var(--panel-raised)', border: '1px solid var(--line)', color: 'var(--parchment-dim)', fontFamily: 'Crimson Pro,serif', fontSize: '14px', padding: '10px', width: '100%', resize: 'vertical', lineHeight: '1.6', outline: 'none' },
  emailReadOnly: { fontFamily: 'Crimson Pro,serif', fontSize: '14px', color: 'var(--gold-dim)', padding: '10px 14px', background: 'var(--panel-raised)', border: '1px solid var(--line)' },
  saveBtn: { background: 'linear-gradient(135deg, var(--gold-bright), var(--gold))', border: 'none', color: '#1a1206', fontFamily: 'Cinzel,serif', fontSize: '11px', letterSpacing: '2px', padding: '13px', cursor: 'pointer', textTransform: 'uppercase', transition: 'all 0.2s' },
  charsSection: { display: 'flex', flexDirection: 'column', gap: '12px' },
  charsTitle: { fontFamily: 'Cinzel,serif', fontSize: '9px', letterSpacing: '3px', color: 'var(--gold-dim)', textTransform: 'uppercase' },
  charsLoading: { fontFamily: 'Crimson Pro,serif', fontStyle: 'italic', fontSize: '13px', color: 'var(--gold-dim)' },
  charsEmpty: { fontFamily: 'Crimson Pro,serif', fontStyle: 'italic', fontSize: '13px', color: 'var(--gold-dim)' },
  charsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '10px' },
  charCard: { display: 'flex', alignItems: 'center', gap: '12px', background: 'var(--panel-raised)', border: '1px solid var(--line)', padding: '10px 14px', cursor: 'pointer', textAlign: 'left', transition: 'all 0.2s' },
  charName: { fontFamily: 'Cinzel,serif', fontSize: '13px', fontWeight: '700', color: 'var(--gold-bright)' },
  charSub: { fontFamily: 'Crimson Pro,serif', fontSize: '12px', color: 'var(--gold-dim)', marginTop: '2px' },
  infoBox: { background: 'rgba(201,164,73,0.04)', border: '1px solid var(--line)', padding: '16px', display: 'flex', flexDirection: 'column', gap: '10px' },
  infoTitle: { fontFamily: 'Cinzel,serif', fontSize: '9px', letterSpacing: '3px', color: 'var(--gold-dim)', textTransform: 'uppercase' },
  infoGrid: { display: 'flex', flexDirection: 'column', gap: '6px' },
  infoItem: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '4px 0', borderBottom: '1px solid var(--line)' },
  infoKey: { fontFamily: 'Cinzel,serif', fontSize: '9px', letterSpacing: '1px', color: 'var(--gold-dim)', textTransform: 'uppercase' },
  infoVal: { fontFamily: 'Crimson Pro,serif', fontSize: '13px', color: 'var(--parchment-dim)' },
  infoNote: { fontFamily: 'Crimson Pro,serif', fontStyle: 'italic', fontSize: '12px', color: 'var(--gold-dim)', marginTop: '4px' },
};
