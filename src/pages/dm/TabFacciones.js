...
const s = {
  ...
  facName: { fontFamily: 'Cinzel,serif', fontSize: '13px', fontWeight: '700', color: '#e8c96a' },
  ...
  facMeta: { fontFamily: 'Crimson Pro,serif', fontSize: '12px', color: '#7a6030' },
  ...
  facDesc: { fontFamily: 'Crimson Pro,serif', fontSize: '12px', color: '#9a8070', lineHeight: '1.5' },
  ...
  repBtn: { background: 'transparent', border: '1px solid rgba(201,168,76,0.15)', color: '#5a4820', fontFamily: 'Cinzel,serif', fontSize: '9px', letterSpacing: '1px', padding: '7px 12px', cursor: 'pointer', textTransform: 'uppercase', transition: 'all 0.2s' },
