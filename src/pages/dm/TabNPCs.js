...
const s = {
  ...
  searchInput: { flex: '1 1 120px', background: 'var(--panel-raised)', border: '1px solid var(--line)', color: 'var(--parchment)', fontFamily: 'Crimson Pro,serif', fontSize: '14px', padding: '9px 12px', outline: 'none' },
  ...
  card: { background: 'var(--panel)', border: '1px solid var(--line)', borderTop: '2px solid var(--gold)', padding: '14px', cursor: 'pointer', display: 'flex', flexDirection: 'column', gap: '6px' },
  cardTop: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '6px' },
  npcName: { fontFamily: 'Cinzel,serif', fontSize: '13px', fontWeight: '700', color: 'var(--gold-bright)' },
  ...
  npcMeta: { fontFamily: 'Crimson Pro,serif', fontSize: '13px', color: 'var(--parchment-dim)' },
  npcTag: { fontFamily: 'Crimson Pro,serif', fontSize: '12px', color: 'var(--gold-dim)' },
  ...
  modal: { background: 'var(--panel)', border: '1px solid var(--line)', borderTop: '3px solid var(--gold)', width: '100%', maxWidth: '620px', position: 'relative', marginTop: '20px' },
